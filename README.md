<p align="center">
  <img
    src="https://github.com/captainayan/lucafy/blob/main/assets/logo.png?raw=true"
    width="96px"
  />
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://lucafy.onrender.com/">Demo 🚀</a>·
...
- **Install Dependencies:** Run `npm i` in the main folder for _backend dependencies_ and run the same command inside frontend folder for _frontend dependencies_
