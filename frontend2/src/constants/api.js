...
export const NORMALIZE_ENTRY_URL = `${BASE_ENTRY_URL}/normalize/`;
export const SEARCH_ENTRY_URL = `${BASE_ENTRY_URL}/search/`;
...
export const GET_EXPORT_JOURNAL_URL = `${BASE_STATEMENT_URL}/export`;
